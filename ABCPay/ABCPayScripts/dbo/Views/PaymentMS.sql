CREATE VIEW [dbo].[PaymentMS]
	...
	[dbo].[Merchants].[MerchantName], [dbo].[Statuses].[StatusName], [dbo].[Payments].[UserId], [dbo].[Payments].[Attachment], [dbo].[Payments].[ProcessedBy] 
	FROM Payments inner join Merchants 
